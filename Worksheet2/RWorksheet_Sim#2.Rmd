...
seq <-c(-5:5)
seq
#It displays the negative and positive numbers, then it displays the 0 between the negative and positive numbers
...
#4a
x[c("first", "third")] #The output displays only the "first" and "third" variables using array
